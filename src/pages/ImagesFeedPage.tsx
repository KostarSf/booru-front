...
import { BlankSearchData, createSearchParams, getSearchParams, SearchData } from "../API/Search";
...
const ImagesFeedPage = () => {
  const [searchData, setSearchData] = useState<SearchData>(BlankSearchData);
  const [searchParams, setSearchParams] = useSearchParams();

  // first_seen_at.gt:5 days ago
